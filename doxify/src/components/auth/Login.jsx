        ...
        <div className="min-h-[80vh] flex items-center">
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl h-fit">
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <button onClick={() => googleSignIn()} className="w-full flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <Link href="/auth/signup" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline font-semibold">or sign up </Link>
